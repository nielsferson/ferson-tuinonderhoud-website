    ...
    <>
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <p>Professioneel tuinonderhoud in Limburg.</p>
      ...
      <section className="home-section">
        ...
        <div className="services-preview-grid">
          {diensten.map((d, i) => (
            <Reveal key={d.slug} delay={i * 60}>
              <Link to={`/diensten#${d.slug}`} className="service-preview-card">
                <span className="service-preview-card-icon">
                  <ServiceIcon name={d.icon} />
                </span>
                <span className="service-preview-card-body">
        ...
        <Link to="/diensten" className="section-link">Meer info over onze diensten →</Link>
      </section>
